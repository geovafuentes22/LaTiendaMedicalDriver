...
<div class="row">
    ...
    <div class="input-field center-align col s12 m4">
        ...
        <a href='../../libraries/reportes/reportegarantia.php' class='btn waves-effect indigo tooltipped fantasmazul' data-tooltip='Reporte de Producto'><i class='material-icons'>assignment</i></a>
    </div>
</div>
